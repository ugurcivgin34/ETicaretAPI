...
namespace ETicaretAPI.Api.Controllers
{
    ...
    [ApiController]
    [Authorize(AuthenticationSchemes = "Admin")] //Bu attiribute yi tanımlazsak jwt tam olarak çalışmayacak, appuser.identity.name kımı dolu olmayacak.Yani ordan kullanıcının bilgilerine ulaşamayız
